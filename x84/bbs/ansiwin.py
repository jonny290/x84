...
GLYPHSETS = {
    ...
    'block': {
        ...
        'bot-left': chr(219).decode('cp437'),
        'top-right': chr(219).decode('cp437'),
        'bot-right': chr(219).decode('cp437'),
        'left-vert': chr(221).decode('cp437'),
        'right-vert': chr(222).decode('cp437'),
        'top-horiz': chr(223).decode('cp437'),
        'bot-horiz': chr(220).decode('cp437'),
    },
    'shadow': {
        'top-left': chr(218).decode('cp437'),
